...
HistoneTreePath <- "/Users/perrinm/Documents/AHocher_Project/TREE/H2A_TREE/Individual_Euk_HF_hits_PostProcessed_H2A_HMM_Subset_Curated_wHmfAB_mafftaligned.fa.clipkit.Rooted.treefile.txt"
  ...
  #Fix names that were altered by IQTree
  ...
  write.tree(PrunedTree,paste0("/Users/perrinm/Documents/AHocher_Project/TREE/",HistoneType,"Unbiased_3.tree"))
  ...
  #missing
  missing <- TipLabel$PrunedTree.tip.label[!TipLabel$PrunedTree.tip.label %in% getName(H2AFastaSeq)]
print(missing)
