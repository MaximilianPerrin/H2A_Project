...
fasta_file <- read.fasta("/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/H2A_H2A_Forced_7.fasta", seqtype = "AA")
firstnames <- gsub(".*\\$(.*?)@.*","\\1", getName(read.fasta("/Users/perrinm/Documents/AHocher_Project/SEQUENCES/FINAL/H2A_Complete_subset_linsi_op075_SpecieNameOnly.fa", seqtype = "AA")))
...
fasta_file <- fasta_file[names(fasta_file) %in% firstnames]
#Write Fasta file 
setwd("/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned")
write.fasta(sequences = fasta_file, 
            names = names(fasta_file), 
            file.out = "H2A_H2A_Forced_7_Species_Only.fasta")
...
FastaDir="/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned"
...
AlignmentPath="/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/H2A_H2A_Forced_7_Species_Only_linsi_op075.fasta"
AlignmentPathNew="/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/H2A_H2A_Forced_Species_Only_linsi_op075_wArchea.fasta"
Command2=paste("mafft --addfragments ",HmfFilepath," ",AlignmentPath," > ",AlignmentPathNew,sep="")
system(Command2)

#Filter the fasta for complete histone set on a rogers tree
fasta_aligned = read.fasta("/Users/perrinm/Documents/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/H2A_H2AX_Forced_Species_Only_linsi_op075_wArchea.fasta", seqtype = "AA")
fasta_aligned <- fasta_aligned[names(fasta_aligned) %in% tree$tip.label]
write.fasta(getSequence(fasta_aligned), getName(fasta_aligned), file.out = "ARogers_H2A_H2AX_Forced_Species_Only_linsi_op075_wArchea.fasta")
...
#Specify File
AlignedFile = "F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/ARogers_H2A_Unbiased_Species_Only_linsi_op075_wArchea.fasta"
...
# For each aligned file, perform ancestral sequence reconstruction using IQ-TREE.
  ...
  RootedTree="F:/UoC/Rotation_1_Hocher/AHocher_Project/TREE/RECONSTRUCTION/ARogers_tree_Grafted_Eukprot_Specieonly_5HistoneSet.wArchaea.tree"
  ...
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
  setwd("F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned")
  
    State = read.table("F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/Unbiased_No_Gaps/ARogers_H2A_Unbiased_Species_Only_linsi_op075_wArchea.fasta.state", skip=1,header=T)
    ...
    write.fasta(as.list(Sequences$Sequence),Sequences$Node,file.out = "H2A_Unbiased_linsi_op075_States.fasta")
  ...
  for(k in 2:length(names(NodesCorresp))){
    ...
    States = read.table("F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/Unbiased_No_Gaps/ARogers_H2A_Unbiased_Species_Only_linsi_op075_wArchea.fasta.state", skip=1,header=T)
    ...
    write.table(States50perNode,file = "H2A_Ubiased_linsi_op075.fasta.statestatewithoutGapsPerNode.txt",sep="\t",quote=F,row.names = F)
    ...
    write.fasta(as.list(SeqReordered$Sequence),SeqReordered$Node, file.out =  "H2A_Ubiased_linsi_op075_nsequences_GapsPerNodes.fa")
  ...
  # Filtering steps, plotting, and saving analysis results involve selective sequence analysis, plotting alignment, and gap percentage visualization, concluding with saving the plots.
    ...
    write.fasta(as.list(SequencesDTNoGap$Sequence[which(NodeNames%in%NodeToPlot)]),SequencesDTNoGap$Node[which(NodeNames%in%NodeToPlot)],file.out = "H2A_Unbiased_linsi_op075_sequencesGap50.fa")
    
    #Export all nodes
    write.fasta(as.list(SequencesDTNoGap$Sequence),SequencesDTNoGap$Node,file.out = "H2A_Ubiased_linsi_op075_AllNodes.sequencesGap50.fa")
    ...
    SeqGap50 = "F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/H2A_Unbiased_linsi_op075_sequencesGap50.fa"
    ...
    filenameWithDate <- "F:/UoC/Rotation_1_Hocher/AHocher_Project/SEQUENCES/H2A_MP/H2A_Sequence_Reconstruction/R7/Aligned/H2A_Unbiased_linsi_op075_sequencesGap50.pdf"
