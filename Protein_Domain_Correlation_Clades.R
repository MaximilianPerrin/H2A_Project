...
#Retain species only of a specific clade
clade_subset <- readLines("/Users/perrinm/Documents/AHocher_Project/TREE/Clade_Lists/Fungi")

H2ASummary <- H2ASummary %>%
  filter(Specie %in% clade_subset)
